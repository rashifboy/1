...
cl = LINETCR.LINE()
cl.login(token="EnkmApqdHpwOl2QlG0s0.2PshkH9jZu06gbOeQKJtua.DrUpTQgVMcBFwaSYTX7fpg10I2/Wv6/6rYkICUAyQPo=")
cl.loginResult()

kt = LINETCR.LINE()
kt.login(token="EmBMZZyqH6ohfn212Wx6.hjHmunzx1zM8NcHQsorFLG.E9sFurBZOD/Gg7M0itkn5zYyzbYgMPles8oLw2SeOzU=")
kt.loginResult()

ks = LINETCR.LINE()
ks.login(token="EmPkBPSTgQA6Y0KOgSB5.PtU14xG9qDZsMoFG8SHeXq.tDlNSYQKu1ExpAoXwdNrV1jW71bLPOZpWAdSkfKHXfM=")
ks.loginResult()

ki = LINETCR.LINE()
ki.login(token="EndxmMD6DkeSMCCISG02.Pr27tThBCOj6We8XoUSeyG.63WWfHjcCgaXUcEb4jMyy0A4GUj2tsi0AjqlE5aZrEQ=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="En3Ctaa6sDrB0dy4uV10.bSfuyestKArlYqYJna4tua.5O3QbTLkX1dGjcTuMxDLsV1reL6n5dCMEU3B8vuUp/M=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Emq6tqWkwAqHbPYrG508.5BKwe+Dtvxmo+2btG4hFwa.o32LfmtrpsYa9QXreiuW8+M+9SDZp6siIYpDmx9MBUM=")
kc.loginResult()


kl = LINETCR.LINE()
kl.login(token="EnCessNSI4XdSGzWbVA0.lzsOKY1M5La0/jHOMItMWa.bMdOsC/EOjA2GWIceGgbK2qH3LK7kZLCj6tNImj90fg=")
kl.loginResult()

print "Done login shif"
reload(sys)
sys.setdefaultencoding('utf-8')
helpMessage= """~~==✯͜͡Bot command͜͡❂==~~
[+]Bot1-6 reaname:
[+]Allrename:
[+]Allbio:
[+]Comment:
...
[+]Time
[+]Mention all
౫This bot create by:-􀰂􀰂􀰂􀰂❂Rs͜͡F➣
"""
